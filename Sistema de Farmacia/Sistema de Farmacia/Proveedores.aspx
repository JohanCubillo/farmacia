<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="Sistema_de_Farmacia.Provee" %>
            ...
            <nav>
                ...
                <ul>
                    <li><a href="Administrador.aspx" style="font-family: Arial; font-size: 16px">Usuarios</a></li>
                     <li><a href="Administrador.aspx" style="font-family: Arial; font-size: 16px">Ver Proveedores</a></li>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="auto-style1">
                                ...
                                <asp:RequiredFieldValidator ID="ValidaciónID" runat="server" ControlToValidate="txtId" ErrorMessage="Debe ingresar una identificacion" ForeColor="Red">*</asp:RequiredFieldValidator>
                            </td>
                            <td class="auto-style1">
